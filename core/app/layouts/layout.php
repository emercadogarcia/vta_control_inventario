...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Inventarios - Ventas | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>INVENTARIO</b> VENTA</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="https://www.facebook.com/emercadogarcia/" target="_blank" class="">Ir a FansPage</a>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2020 <a href="https://www.facebook.com/emercadogarcia/" target="_blank">@emercadogarcia</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">INVENTARIO<b> VENTAS</b></a>
      </div><!-- /.login-logo -->
